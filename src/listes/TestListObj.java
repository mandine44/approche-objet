...
public class TestListObj {
	...
	public static void main(String[] args) {
		...
		/*while (iter.hasNext()) {
			...
			if (uneVille.nbHabitants > nbMaxHabitants) {
				nbMaxHabitants = uneVille.nbHabitants;
				LaPlusGrosseVille=uneVille;
			}
		}
		...
		while (iter.hasNext()) {
			...
			if (uneVille.nbHabitants < nbMinHabitants) {
				//System.out.println("Je suis dans la boucle");
				nbMinHabitants = uneVille.nbHabitants;
